        ...
        <div className={styles.container}>
            <div onClick={() => setIsExpanded(!isExpanded)} className={styles.header}>
                ...
                <div className={styles.headerContents}>
                    ...
                    <div className={clsx(styles.chevron, isExpanded && styles.chevronExpanded)}><ChevronDownIcon /></div>
                </div>
            </div>
            <div className={clsx(styles.details, isExpanded && styles.detailsExpanded)}>
                {children}
            </div>
        </div>
    )
